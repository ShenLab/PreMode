...
# archived functions
class EquivariantBinaryClassificationSAGPoolScalar(EquivariantScalar):
    def __init__(
            self,
            args,
            activation="sigmoid",
...
class EquivariantBinaryClassificationNoGraphTanhScalar(EquivariantNoGraphScalar):
    def __init__(
            self,
            args,
            activation="tanh",
...
class EquivariantTanhStarPoolScalar(EquivariantStarPoolScalar):
    def __init__(
            self,
            args,
            activation="tanh",
...
class EquivariantTanhScalar(EquivariantScalar):
    def __init__(
            self,
            args,
            activation="tanh",
...
class EquivariantBinaryClassificationTanh2Scalar(EquivariantScalar):
    def __init__(
            self,
            args,
            activation="tanh",
...
class EquivariantRegressionSAGPoolScalar(EquivariantScalar):
    def __init__(
            self,
            args,
            activation="pass",
