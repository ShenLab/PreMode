...
famcacscn <- as.data.frame(fread("/share/pascal/Users/gz2294/Data/DMS/Ion_Channel/funNCion/scncacaa_familyalignedCACNA1Acantranscript.txt"))
featuretable <- fread("/share/pascal/Users/gz2294/Data/DMS/Ion_Channel/funNCion/featuretable4github_revision.txt")
...
varall <- fread("/share/pascal/Users/gz2294/Data/DMS/Ion_Channel/funNCion/SupplementaryTable_S1_pathvariantsusedintraining_revision2.txt")
...
source("/share/pascal/Users/gz2294/Data/DMS/Ion_Channel/funNCion/R_functions4predicting_goflof_CACNA1SCN.R")
...
for (o in 1:length(genes)) {
  for (fold in 0:4) {
    gene <- genes[o]
    print(gene)
    premode.yaml <- yaml::read_yaml(paste0('/share/vault/Users/gz2294/PreMode/scripts/CHPs.v4.esm.dssp.small.StarAttn.MSA.StarPool.1dim/', 
...
for (fold in 0) {
  ...
  heyne.result <- read.csv('/share/pascal/Users/gz2294/Data/DMS/Ion_Channel/funNCion/fuNCion.predictions.csv', row.names = 1)
  premode.auc <- plot.AUC(gene.testing.result$score, gene.testing.result$logits)
...
ggsave(paste0('figs/02.02.ICC.tasks.compare.heyne.pdf'), p, height = 6, width = 6)
