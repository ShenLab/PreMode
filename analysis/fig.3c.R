...
CHPs.test <- read.csv('../PreMode.results/PreMode.seed.0/test_result.step.30000.csv', row.names = 1)
CHPs.test.no.esm <- read.csv('../PreMode.results/PreMode.noESM.seed.0/test_result.step.56000.csv', row.names = 1)
CHPs.test.no.se3 <- read.csv('../PreMode.results/ESM.SLR.seed.0/test_result.step.88000.csv', row.names = 1)
CHPs.test.no.structure <- read.csv('../PreMode.results/PreMode.noStructure.seed.0/test_result.step.15000.csv', row.names = 1)
CHPs.test.no.MSA <- read.csv('../PreMode.results/PreMode.noMSA.seed.0/test_result.step.42000.csv', row.names = 1)
