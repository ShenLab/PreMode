...
out.dir.1 <- 'figs/02.02.ICC.tasks.compare.itan.pdf'
...
result.plot <- result.plot[result.plot$model %in% c("PreMode.noItan", 
                                                    ...
                                                    # "PreMode.PRE.v8/", 
                                                    "Itan.1"),]
model.dic <- c("PreMode.noItan"="1: PreMode (148k)",
               "PreMode.large.window.noItan"="2: PreMode (148k, large window)",
               # "PreMode.PRE.v8/"="3: PreMode (8.3M)",
               "Itan.1"="3: LoGoFunc"
               )
