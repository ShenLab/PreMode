...
system('mv 5genes.all.mut/inference.results/P60484.subset.1.fold.0.part.pdf figs/fig.sup.15a.pdf')
system('mv 5genes.all.mut/inference.results/P60484.subset.2.fold.0.part.pdf figs/fig.sup.15b.pdf')
system('mv 5genes.all.mut/inference.results/P60484.subset.4.fold.0.part.pdf figs/fig.sup.15c.pdf')
system('mv 5genes.all.mut/inference.results/P60484.subset.6.fold.0.part.pdf figs/fig.sup.15d.pdf')
