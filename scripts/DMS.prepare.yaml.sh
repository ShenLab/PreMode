...
for gene in PTEN PTEN.bin CCR5 CXCR4 NUDT15 VKORC1 SNCA CYP2C9 GCK ASPA DDX3X Stab MPL MPL.Position $(cat scripts/pfams.txt) $(cat scripts/gene.pfams.txt) $(cat /share/pascal/Users/gz2294/Data/DMS/Hsu_NBT/useful.data.human.csv)
do
  # change load model
...
for gene in PTEN PTEN.bin CCR5 CXCR4 NUDT15 VKORC1 SNCA CYP2C9 GCK ASPA DDX3X Stab MPL MPL.Position $(cat /share/pascal/Users/gz2294/Data/DMS/Hsu_NBT/useful.data.human.csv)
do
...
for gene in PTEN PTEN.bin NUDT15 VKORC1 SNCA CYP2C9 GCK ASPA Stab 
do
...
# change seed
for gene in PTEN PTEN.bin CCR5 CXCR4 NUDT15 VKORC1 SNCA CYP2C9 GCK ASPA DDX3X Stab MPL MPL.Position $(cat scripts/pfams.txt) $(cat scripts/gene.pfams.txt) AAV GB1 B_LAC fluorescence
do
  # use original yaml as template
...
for gene in PTEN PTEN.bin NUDT15 CCR5 CXCR4 VKORC1 SNCA CYP2C9 GCK ASPA Stab MPL MPL.Position
do
  mkdir $1/$gene.5fold/
  cp $1/$gene/$gene.seed.0.yaml $1/$gene.5fold/$gene.fold.0.yaml
  for fold in {1..4}
