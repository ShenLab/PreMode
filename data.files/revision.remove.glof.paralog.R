...
dir.create('pretrain/revision.remove.glof.paralog/', recursive = T, showWarnings = F)
write.csv(pretrain[pretrain$uniprotID %in% quarter.1,], "pretrain/revision.remove.glof.paralog/training.0.csv", na = ".")
write.csv(pretrain[pretrain$uniprotID %in% quarter.2,], "pretrain/revision.remove.glof.paralog/training.1.csv", na = ".")
write.csv(pretrain[pretrain$uniprotID %in% quarter.3,], "pretrain/revision.remove.glof.paralog/training.2.csv", na = ".")
write.csv(pretrain[pretrain$uniprotID %in% quarter.4,], "pretrain/revision.remove.glof.paralog/training.3.csv", na = ".")
write.csv(pretrain, 'pretrain/revision.remove.glof.paralog/training.csv', na = ".")
